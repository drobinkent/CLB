                        ...
                        inout standard_metadata_t standard_metadata)
{
    ...
    register<bit<19>>(MAX_PORTS_IN_SWITCH) port_egress_queue_avg_depth;
    ...
    apply{
            ...
            //Rate control.
        {
            ...
            port_egress_queue_avg_depth.read(old_deq_depth, port_id);
            ...
            port_egress_queue_avg_depth.write(port_id, standard_metadata.deq_qdepth );
            #endif
        }
    }
