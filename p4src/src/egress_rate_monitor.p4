...
{
    register<bit<32>>(MAX_PORTS_IN_SWITCH) path_last_updated_rate;
    ...
    action monitor_outgoing_flow() {
        ...
        path_last_updated_rate.read(local_metadata.temp, port_id);
        path_last_updated_rate.write( port_id,  local_metadata.egress_rate_event_hdr.egress_traffic_color);
        local_metadata.egress_rate_event_hdr.egress_rate_event_port =  standard_metadata.egress_port ;
    }
